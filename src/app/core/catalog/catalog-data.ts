...
export const ANIMES: readonly Anime[] = [
...
export const PRODUCTS: readonly Product[] = [
  {
    ...
    packed: { length: 30, width: 22, height: 4, weight: 0.25 },
  ...
  },
  {
    id: 'p-02',
    slug: 'broche-fern',
    packed: { length: 12, width: 10, height: 2, weight: 0.05 },
  ...
  },
  {
    id: 'p-03',
    slug: 'figure-gojo',
    packed: { length: 32, width: 24, height: 24, weight: 1.6 },
  ...
  },
  {
    id: 'p-04',
    slug: 'colar-pochita',
    packed: { length: 12, width: 10, height: 4, weight: 0.12 },
  ...
  },
  {
    id: 'p-05',
    slug: 'peruca-makima',
    packed: { length: 35, width: 28, height: 14, weight: 0.5 },
  ...
  },
  {
    ...
    packed: { length: 28, width: 20, height: 16, weight: 0.6 },
  ...
  },
  {
    id: 'p-08',
    slug: 'chapeu-luffy',
    packed: { length: 42, width: 42, height: 14, weight: 0.4 },
  ...
  },
  {
    id: 'p-09',
    slug: 'figure-anya',
    packed: { length: 24, width: 18, height: 18, weight: 0.9 },
  ...
  },
  {
    id: 'p-10',
    slug: 'cajado-fern',
    packed: { length: 85, width: 14, height: 14, weight: 1.1 },
    ...
    options: {
      ...
      values: [
        ...
        { id: '1-1', label: '1,40 m', note: 'Escala 1:1', price: 389, availability: order(18) , packed: { length: 75, width: 16, height: 16, weight: 1.6 } },
      ],
    },
  },
  {
    ...
    packed: { length: 65, width: 20, height: 10, weight: 2.4 },
    ...
    options: {
      ...
      values: [
        ...
        { id: '145cm', label: '1,45 m', note: 'Escala 1:1', price: 1290, availability: order(30) , packed: { length: 80, width: 26, height: 14, weight: 5.8 } },
      ],
    },
  },
  {
    id: 'p-12',
    slug: 'lanca-longinus',
    packed: { length: 45, width: 12, height: 12, weight: 0.7 },
    ...
    options: {
      ...
      values: [
        ...
        { id: '90cm', label: '90 cm', note: 'De chão', price: 329, availability: order(16) , packed: { length: 95, width: 14, height: 14, weight: 1.4 } },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    packed: { length: 16, width: 12, height: 2, weight: 0.15 },
